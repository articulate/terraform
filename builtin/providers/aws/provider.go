...
func Provider() terraform.ResourceProvider {
	...
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"awseb_elastic_beanstalk_application":            resourceAwsElasticBeanstalkApplication(),
			"awseb_elastic_beanstalk_configuration_template": resourceAwsElasticBeanstalkConfigurationTemplate(),
			"awseb_elastic_beanstalk_environment":            resourceAwsElasticBeanstalkEnvironment(),
